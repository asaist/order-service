...
//
    ...
    public List<Mkb10Dto> getEntityLocalizationList() throws JsonProcessingException {
        RestTemplate restTemplate = new RestTemplate();
        ...
        HttpEntity<String> response2 = restTemplate.exchange(
                "http://172.26.1.156:2989/values?limit=15000&param_id=10",
                HttpMethod.GET,
                entity,
                String.class
        );
...
//
    ...
    public List<Mkb10Dto> getEntityDisciplineList() throws JsonProcessingException {
        RestTemplate restTemplate = new RestTemplate();
        ...
        HttpEntity<String> response2 = restTemplate.exchange(
                "http://172.26.1.156:2989/values?limit=15000&param_id=11",
                HttpMethod.GET,
                entity,
                String.class
        );
...
//
    ...
    public List<Mkb10Dto> getEntitySpravochnikList() throws JsonProcessingException {
        RestTemplate restTemplate = new RestTemplate();
